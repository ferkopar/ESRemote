...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "VT_GIS_DATA" ("GIS_ID", "GIS_TYPE_ID", "T_GIS_TYPE_NAME", "COUNTRY", "CITY", "PLZ", "ADRESS", "STREET", "HOUSE_NUM", "LAT", "LON", "LATLON", "DESCRIPTION", "CRU", "CRD", "MDU", "MDD") AS 
  SELECT GIS_ID,
    GIS_TYPE_ID,
