...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_MENU" ("MENU_ITEM_ID", "MENU_ITEM_NAME", "DISPLAY_NAME", "GROUP_ID", "APEX_VARIABLE", "CONTROL_ITEM_ID", "CONTROL_ITEM_NAME", "ASSIGNED_ROLE_ID", "ASSIGNED_ROLE_NAME") AS 
  select  
