--------------------------------------------------------
--  DDL for Trigger LTRG_DM_ROLE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "LTRG_DM_ROLE" 
AFTER INSERT OR UPDATE OR DELETE ON AMNIS.DM_ROLE FOR EACH ROW
DECLARE
BEGIN
BEGIN
DECLARE
V_TNAME VARCHAR2(30) := 'DM_ROLE';
VALUE_EX EXCEPTION;
...
:new.ROLE_ID,'U',admin_pkg.apex_user,
'ROLE_ID',:old.ROLE_ID,:new.ROLE_ID,v('EPI_ID') );
END IF;
IF   (:new.ROLE_NAME IS NULL AND :old.ROLE_NAME IS NOT NULL)
  OR (:new.ROLE_NAME IS NOT NULL AND :old.ROLE_NAME IS NULL)
  OR (:new.ROLE_NAME != :old.ROLE_NAME) THEN 
INSERT INTO LOG_TABLE
(LOG_ID, OPERATION_TIME, TABLE_NAME,
RECORD_ID, OPERATION_TYPE, USER_NAME,
 COLUMN_NAME, OLD_VALUE, NEW_VALUE,EPI_ID)
...
(SEQ_LTRG_ID.nextval,sysdate,V_TNAME,
:new.ROLE_ID,'U',admin_pkg.apex_user,
'ROLE_NAME',:old.ROLE_NAME,:new.ROLE_NAME,v('EPI_ID') );
END IF;
...
VALUES
(SEQ_LTRG_ID.nextval,sysdate,V_TNAME,
:old.ROLE_ID,'D',admin_pkg.apex_user,
'ROLE_ID',:old.ROLE_ID,:new.ROLE_ID,v('EPI_ID') );
INSERT INTO LOG_TABLE
(LOG_ID, OPERATION_TIME, TABLE_NAME,
RECORD_ID, OPERATION_TYPE, USER_NAME,
...
VALUES
(SEQ_LTRG_ID.nextval,sysdate,V_TNAME,
:new.ROLE_ID,'I',admin_pkg.apex_user,
...
END;
/
ALTER TRIGGER "LTRG_DM_ROLE" DISABLE;
