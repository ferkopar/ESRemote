...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "APEXLIB_V_PAGE_REGION" ("ID", "APPLICATION_ID", "PAGE_ID", "NAME", "SOURCE_TYPE", "SOURCE", "SOURCE_UPPER", "DISPLAY_SEQUENCE", "HEADING_TYPE", "HEADING_SOURCE", "USES_APEX_ITEM", "IGNORE_VALIDATION", "HIDE_SELECT_ALL", "CONDITION_TYPE", "CONDITION_EXPRESSION1", "CONDITION_EXPRESSION2", "NOT_AUTHORIZATION", "AUTHORIZATION_SCHEME") AS 
  SELECT ID
     , APPLICATION_ID
     , PAGE_ID
     , NAME
