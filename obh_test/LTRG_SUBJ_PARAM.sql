--------------------------------------------------------
--  DDL for Trigger LTRG_SUBJ_PARAM
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "LTRG_SUBJ_PARAM" 
AFTER INSERT OR UPDATE OR DELETE ON AMNIS.SUBJ_PARAM FOR EACH ROW
DECLARE
BEGIN
BEGIN
DECLARE
V_TNAME VARCHAR2(30) := 'SUBJ_PARAM';
VALUE_EX EXCEPTION;
INSERT_EXC EXCEPTION;
BEGIN
IF updating THEN
begin
IF   (:new.SUBJ_PARAM_ID IS NULL AND :old.SUBJ_PARAM_ID IS NOT NULL)
  OR (:new.SUBJ_PARAM_ID IS NOT NULL AND :old.SUBJ_PARAM_ID IS NULL)
  OR (:new.SUBJ_PARAM_ID != :old.SUBJ_PARAM_ID) THEN 
...
:new.SUBJ_PARAM_ID,'U',admin_pkg.apex_user,
'SUBJ_PARAM_ID',:old.SUBJ_PARAM_ID,:new.SUBJ_PARAM_ID,v('EPI_ID') );
END IF;
...
VALUES
(SEQ_LTRG_ID.nextval,sysdate,V_TNAME,
:old.SUBJ_PARAM_ID,'D',admin_pkg.apex_user,
'SUBJ_PARAM_ID',:old.SUBJ_PARAM_ID,:new.SUBJ_PARAM_ID,v('EPI_ID') );
INSERT INTO LOG_TABLE
(LOG_ID, OPERATION_TIME, TABLE_NAME,
RECORD_ID, OPERATION_TYPE, USER_NAME,
...
VALUES
(SEQ_LTRG_ID.nextval,sysdate,V_TNAME,
:new.SUBJ_PARAM_ID,'I',admin_pkg.apex_user,
...
END;
/
ALTER TRIGGER "LTRG_SUBJ_PARAM" ENABLE;
