...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "APEXLIB_V_REPORT_COLUMN" ("ID", "APPLICATION_ID", "REGION_ID", "NAME", "HEADING", "DISPLAY_SEQUENCE", "DISPLAY_AS", "FORMAT_MASK", "IS_HIDDEN", "IS_REQUIRED", "MAX_LENGTH", "MIN_VALUE", "MAX_VALUE", "ONLY_UPPERCASE", "ONLY_LOWERCASE", "ONLY_CAPITALIZED", "IS_VERTICAL_RESIZEABLE", "LINK_URL", "LOV_NAMED_LOV_ID", "LOV_TYPE", "LOV_QUERY", "LOV_DISPLAY_NULL", "LOV_DISPLAY_EXTRA_VALUES", "LOV_NULL_TEXT", "LOV_NULL_VALUE", "CONDITION_TYPE", "CONDITION_EXPRESSION1", "CONDITION_EXPRESSION2", "NOT_AUTHORIZATION", "AUTHORIZATION_SCHEME") AS 
  SELECT ID
     , APPLICATION_ID
     , REGION_ID
     , NAME
