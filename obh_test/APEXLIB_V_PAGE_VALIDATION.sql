...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "APEXLIB_V_PAGE_VALIDATION" ("ID", "APPLICATION_ID", "PAGE_ID", "NAME", "VALIDATION_FAILURE_TEXT", "ASSOCIATED_ITEM_ID", "ASSOCIATED_ITEM_NAME") AS 
