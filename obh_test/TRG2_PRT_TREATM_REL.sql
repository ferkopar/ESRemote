--------------------------------------------------------
--  DDL for Trigger TRG2_PRT_TREATM_REL
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "TRG2_PRT_TREATM_REL" 
BEFORE INSERT OR UPDATE ON AMNIS.PRT_TREATM_REL FOR EACH ROW
BEGIN
IF INSERTING THEN
IF 
 :NEW.TREATM_REL_ID IS NULL THEN
  SELECT SEQ_BASE.NEXTVAL 
 INTO :NEW.TREATM_REL_ID FROM DUAL;
END IF;
...
END;
/
ALTER TRIGGER "TRG2_PRT_TREATM_REL" ENABLE;
