...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_TREATM_PRU_SCR" ("TREATM_PRU_ID", "EDIT", "INVALIDATE", "SUBJ_ID", "SUBJ_NAME", "TYPE_ID", "TYPE_NAME", "PARAM_TYPE_ID", "PARAM_TYPE_NAME", "VALUE", "UNIT_TYPE_ID", "UNIT_TYPE_NAME", "EPI_ID", "MM_ID", "DESCRIPTION", "FROM_DATE", "TO_DATE", "STATUS_ID", "STATUS_NAME", "CRU", "CRD", "MDU", "MDD") AS 
  select 
 "TREATM_PRU_ID",
 "TREATM_PRU_ID" edit, 
