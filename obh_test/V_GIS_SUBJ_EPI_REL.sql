...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_GIS_SUBJ_EPI_REL" ("G_GIS_ID", "G_GIS_TYPE_ID", "G_COUNTRY", "G_CITY", "G_PLZ", "G_ADRESS", "G_STREET", "G_HOUSE_NUM", "G_LAT", "G_LON", "G_LATLON", "G_DESCRIPTION", "G_CRU", "G_CRD", "G_MDU", "G_MDD", "GSEP_REL_ID", "GSEP_REL_TYPE_ID", "GSEP_GIS_ID", "GSEP_SUBJ_ID", "GSEP_EPI_ID", "GSEP_DESCRIPTION", "GSEP_CRU", "GSEP_CRD", "GSEP_MDU", "GSEP_MDD") AS 
