...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_DM_ROLE" ("ROLE_USER_ID", "USER_ID", "ROLE_ID", "USER_SUBJ_ID", "USER_NAME", "DESCRIPTION", "ORG_ID", "ORG_NAME", "DATA_OWNER_ID", "ROLE_NAME", "SUPER_TYP_ID") AS 
  SELECT 
