...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "VT_DM_LANGUAGE" ("LANGUAGE_ID", "T_LANGUAGE_NAME", "LANGUAGE_TYP", "APEX_LANGUAGE", "RL", "DESCRIPTION", "FROM_DATE", "TO_DATE", "CRU", "CRD", "MDU", "MDD", "LANGUAGE_CODE") AS 
  SELECT LANGUAGE_ID,
