...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_TREATM_DOCS" ("TREATM_ID", "LINK", "TREATM_NAME", "TREATM_GROUP_ID", "TREATM_GROUP_NAME", "TREATM_TYPE_ID", "TREATM_TYPE_NAME", "TREATM_CATEGORY_ID", "TREATM_CATEGORY_NAME", "TYPE1_ID", "TYPE1_NAME", "TYPE2_ID", "TYPE2_NAME", "TREATM_ID1", "TREATM_ID2", "KOD1", "KOD2", "STATUS_ID", "STATUS_NAME", "REL_TYPE_ID", "REL_TYLE_NAME", "TREATM_REL_ID") AS 
