...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "INSERT_TR_XL_ROW" 
  (
    p_value varchar ,
...
BEGIN
 ...
 -- insert INTO WK_PF_AUDIT_TABLE VALUES('p_order_no',p_order_no);
   ...
   INSERT INTO tr_xl (list_type_id,param_type_id,column_data_type_id,param_value,param_value_chr,order_no,column_no,data_inco_id)
   VALUES  (v_dm_xl_row.list_type_id,p_param_type_id,v_dm_xl_row.param_type_id,p_value,p_value,p_order_no,v_dm_xl_row.order_no,p_treatm_id)
   RETURNING tr_xl_id INTO v_tr_xl_id;
   RETURN v_tr_xl_id;
  RETURN v_tr_xl_id;
END;
