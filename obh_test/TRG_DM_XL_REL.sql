--------------------------------------------------------
--  DDL for Trigger TRG_DM_XL_REL
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "TRG_DM_XL_REL" 
BEFORE INSERT OR UPDATE ON AMNIS.DM_XL_REL FOR EACH ROW
BEGIN
  IF INSERTING
  THEN
...
END TRG_DM_XL_REL;
/
ALTER TRIGGER "TRG_DM_XL_REL" ENABLE;
