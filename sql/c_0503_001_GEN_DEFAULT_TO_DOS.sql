  ...
  for treatment in treatments(v_user_id) 
    LOOP
      ...
      -- AND   TREATM_CATEGORY_ID = v_treatm.TREATM_CATEGORY_ID
       ...
       INSERT INTO TREATM (TREATM_ID, TREATM_NAME, TREATM_GROUP_ID,TREATM_CATEGORY_ID, TREATM_TYPE_ID, TIME_START,TYPE1_ID,SUBJ1_ID,STATUS_ID )
                   VALUES (v_new_treatm_id,TO_CHAR(SYSDATE,'YYYY.MM.DD HH24:MI.SS')||' '||v_treatm.TREATM_NAME,1604,
                           v_treatm.TREATM_CATEGORY_ID,v_treatm.TREATM_TYPE_ID,SYSDATE,v_treatm.TYPE1_ID,1308590112,913);
